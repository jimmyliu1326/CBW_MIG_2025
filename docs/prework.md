# CBW Module 6 Pre-work

Trainees are highly encouraged to install **Bandage** in advance to attending the workshop.
...
- [Linux Ubuntu 14.04+](https://github.com/rrwick/Bandage/releases/download/v0.8.1/Bandage_Ubuntu_static_v0_8_1.zip)

- [Linux Ubuntu 18.04+](https://github.com/rrwick/Bandage/releases/download/v0.9.0/Bandage_Ubuntu-x86-64_v0.9.0_AppImage.zip)

- [Linux CentOS](https://github.com/rrwick/Bandage/releases/download/v0.8.1/Bandage_CentOS_static_v0_8_1.zip)
